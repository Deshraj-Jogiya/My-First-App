...
import com.DJ.emoji.listeners.OnEmojiBackspaceClickListener;
import com.DJ.emoji.listeners.OnEmojiClickListener;
import com.DJ.emoji.listeners.OnEmojiLongClickListener;
import com.DJ.emoji.listeners.OnEmojiPopupDismissListener;
import com.DJ.emoji.listeners.OnEmojiPopupShownListener;
import com.DJ.emoji.listeners.OnSoftKeyboardCloseListener;
import com.DJ.emoji.listeners.OnSoftKeyboardOpenListener;
...
@SuppressWarnings("PMD.GodClass") public final class EmojiPopup implements EmojiResultReceiver.Receiver {
  ...
  public static final class Builder {
    ...
    @CheckResult public Builder setRecentEmoji(@NonNull final RecentEmoji recent) {
      recentEmoji = Utils.checkNotNull(recent, "recent can't be null");
      return this;
    }
    ...
    @CheckResult public Builder setVariantEmoji(@NonNull final VariantEmoji variant) {
      variantEmoji = Utils.checkNotNull(variant, "variant can't be null");
      return this;
    }
